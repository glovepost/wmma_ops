...
python3 tools/remap_workgroup_5x8_asm.py \
    traces/bp-publish-lgkm0.s traces/bp-remap-5x8.s
python3 tools/remap_workgroup_5x8_asm.py \
    traces/bp-publish-lgkm0.s traces/bp-remap-5x8-skew.s --skew

for candidate in bp-remap-5x8 bp-remap-5x8-skew; do
