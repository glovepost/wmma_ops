...
hipcc "${common[@]}" --cuda-device-only -S rocwmma_half_record.hip \
    -o traces/bp-early-buffer-base.s
hipcc "${common[@]}" -DWMMA_BP_NO_EXPLICIT_VMWAIT=1 \
    --cuda-device-only -S rocwmma_half_record.hip \
    -o traces/bp-early-buffer-no-explicit-base.s
python3 tools/patch_buffer_prefetch_asm.py \
    traces/bp-early-buffer-base.s traces/bp-buffer-stage.s
python3 tools/patch_buffer_prefetch_asm.py \
    traces/bp-early-buffer-base.s traces/bp-buffer-soffset-stage.s \
    --scalar-offset
python3 tools/patch_early_buffer_prefetch_asm.py \
    traces/bp-buffer-stage.s traces/bp-early-buffer-prefetch-hand.s
python3 tools/patch_early_buffer_prefetch_asm.py \
    traces/bp-buffer-soffset-stage.s \
    traces/bp-early-buffer-prefetch-soffset-hand.s
python3 tools/patch_buffer_prefetch_asm.py \
    traces/bp-early-buffer-no-explicit-base.s \
    traces/bp-buffer-no-explicit-stage.s
python3 tools/patch_buffer_prefetch_asm.py \
    traces/bp-early-buffer-no-explicit-base.s \
    traces/bp-buffer-soffset-no-explicit-stage.s --scalar-offset
python3 tools/patch_early_buffer_prefetch_asm.py \
    traces/bp-buffer-no-explicit-stage.s \
    traces/bp-early-buffer-prefetch-no-explicit-hand.s
python3 tools/patch_early_buffer_prefetch_asm.py \
    traces/bp-buffer-soffset-no-explicit-stage.s \
    traces/bp-early-buffer-prefetch-soffset-no-explicit-hand.s

for candidate in \
    bp-early-buffer-prefetch-hand \
    bp-early-buffer-prefetch-soffset-hand \
    bp-early-buffer-prefetch-no-explicit-hand \
    bp-early-buffer-prefetch-soffset-no-explicit-hand; do
